...
--   'F:\Mirek\STUDIA INFORMATYKA\TB2\movie_drop.sql'
...
-- Alter table to add new constraints required to implement the "Product_Rating" relationship
...
-- Alter table to add new constraints required to implement the "Customer_Cust_category" relationship
...
-- Alter table to add new constraints required to implement the "Order_details_Order" relationship
...
-- Alter table to add new constraints required to implement the "Order_Customer" relationship
